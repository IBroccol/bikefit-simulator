...
def validate_register_data(data: Dict[str, Any]) -> ValidationResult:
    ...
    if not password:
        ...
        result.add_error("password", "Пароль должен содержать не более 100 символов")
...
def validate_login_data(data: Dict[str, Any]) -> ValidationResult:
    ...
    if not username:
        ...
        result.add_error("username", "Имя пользователя должно содержать максимум 50 символов")
